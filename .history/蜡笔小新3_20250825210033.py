...
class DeskPet(QtWidgets.QLabel):
    ...
    def startIdle(self):
        ...
        self.currentAction = self.startIdle
        self.images = self.loadImages("/home/kyle/labi/LaBiDeskPet/resource/xianzhi")
        self.currentImage = 0
        # 重新连接通用动画更新
        self.timer.timeout.connect(self.updateAnimation)
    ...
    def sleep(self):
        ...
        sleep_images = self.loadImages("Deskpet/resource/sleep")
        if not sleep_images:
            return
    ...
    def WakeUp(self):
        ...
        wake_images = self.loadImages("Deskpet/resource/waken")
        if not wake_images:
            return
